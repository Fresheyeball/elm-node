...
Elm.Node = Elm.Node || {};
Elm.Node.Streams = Elm.Node.Streams || {};
Elm.Node.Streams.Types = Elm.Node.Streams.Types || {};
Elm.Node.Streams.Types.make = function (_elm) {
   "use strict";
   _elm.Node = _elm.Node || {};
   _elm.Node.Streams = _elm.Node.Streams || {};
   _elm.Node.Streams.Types = _elm.Node.Streams.Types || {};
   if (_elm.Node.Streams.Types.values)
   return _elm.Node.Streams.Types.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var _op = {};
   var splitDuplex = function (_p0) {
      var _p1 = _p0;
      return {ctor: "_Tuple2"
             ,_0: {readable: _p1.readable}
             ,_1: {writable: _p1.writable}};
   };
   var Duplex = F2(function (a,b) {
      return {readable: a,writable: b};
   });
   var Writable = function (a) {    return {writable: a};};
   var Readable = function (a) {    return {readable: a};};
   var WriteRaw = {ctor: "WriteRaw"};
   var ReadRaw = {ctor: "ReadRaw"};
   var toNameW = function (e) {
      var _p2 = e;
      switch (_p2.ctor)
      {case "Drain": return "drain";
         case "Pipe": return "pipe";
         case "Unpipe": return "unpipe";
         case "Finish": return "finish";
         default: return "error";}
   };
   var toNameR = function (e) {
      var _p3 = e;
      switch (_p3.ctor)
   ...
   var ChunkRaw = {ctor: "ChunkRaw"};
   var WriteError = {ctor: "WriteError"};
   var Finish = {ctor: "Finish"};
   var Unpipe = {ctor: "Unpipe"};
   var Pipe = {ctor: "Pipe"};
   var Drain = {ctor: "Drain"};
   var ReadError = {ctor: "ReadError"};
   var End = {ctor: "End"};
   var Close = {ctor: "Close"};
   var Read = {ctor: "Read"};
   var Data = {ctor: "Data"};
   return _elm.Node.Streams.Types.values = {_op: _op
                                           ,Data: Data
                                           ,Read: Read
                                           ,Close: Close
                                           ,End: End
...
Elm.Node.FS.Streams = Elm.Node.FS.Streams || {};
Elm.Node.FS.Streams.make = function (_elm) {
   "use strict";
   _elm.Node = _elm.Node || {};
   _elm.Node.FS = _elm.Node.FS || {};
   _elm.Node.FS.Streams = _elm.Node.FS.Streams || {};
   if (_elm.Node.FS.Streams.values)
   return _elm.Node.FS.Streams.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Node$FS$Streams = Elm.Native.Node.FS.Streams.make(_elm),
   $Node$Streams$Types = Elm.Node.Streams.Types.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var createWriteStream$ = $Native$Node$FS$Streams.createWriteStream;
   var createWriteStream = function (_p0) {
      return A2($Task.map,
      $Node$Streams$Types.Writable,
      createWriteStream$(_p0));
   };
   var createReadStream$ = $Native$Node$FS$Streams.createReadStream;
   var createReadStream = function (_p1) {
      return A2($Task.map,
      $Node$Streams$Types.Readable,
      createReadStream$(_p1));
   };
   return _elm.Node.FS.Streams.values = {_op: _op
...
Elm.Node = Elm.Node || {};
Elm.Node.Streams = Elm.Node.Streams || {};
Elm.Node.Streams.make = function (_elm) {
   "use strict";
   _elm.Node = _elm.Node || {};
   _elm.Node.Streams = _elm.Node.Streams || {};
   if (_elm.Node.Streams.values) return _elm.Node.Streams.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$Node$Streams = Elm.Native.Node.Streams.make(_elm),
   $Node$Streams$Types = Elm.Node.Streams.Types.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var utf8 = "utf8";
   var logBuffer = $Native$Node$Streams.logBuffer;
   var pipe$ = $Native$Node$Streams.pipe;
   var pipe = F2(function (r,w) {
      return A2(pipe$,
      function (_) {
         return _.readable;
      }(r),
   ...
   var on$ = $Native$Node$Streams.on;
   var on = F3(function (f,e,r) {
      return A3(on$,
      $Node$Streams$Types.toNameR(e),
      function (_) {
         return _.readable;
      }(r),
      f);
   });
   return _elm.Node.Streams.values = {_op: _op
                                     ,on$: on$
                                     ,on: on
                                     ,pipe$: pipe$
                                     ,pipe: pipe
...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Node$FS$Streams = Elm.Node.FS.Streams.make(_elm),
   $Node$Streams = Elm.Node.Streams.make(_elm),
   $Node$Streams$Types = Elm.Node.Streams.Types.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var run = Elm.Native.Task.make(_elm).perform(function () {
      var go = F2(function (r,w) {
         return A2($Task.andThen,
         A3($Node$Streams.on,
         $Node$Streams.logBuffer($Node$Streams.utf8),
         $Node$Streams$Types.Data,
         r),
         $Basics.always(A2($Node$Streams.pipe,r,w)));
      });
      var sync = $Node$FS$Streams.createWriteStream("README-CLONE.md");
      var src = $Node$FS$Streams.createReadStream("README.md");
      return A2($Task.andThen,
      A3($Task.map2,go,src,sync),
      $Basics.identity);
   }());
