...
Elm.Http.Server.Raw.make = function (_elm) {
   ...
   var textHtml = {ctor: "_Tuple2"
                  ,_0: "Content-Type"
                  ,_1: "text/html"};
   var statusCode = $Native$Http.statusCode;
   var method$ = $Native$Http.method;
   var url = $Native$Http.url;
   var emptyRes = $Native$Http.emptyRes;
   var emptyReq = $Native$Http.emptyReq;
   var end = $Native$Http.end;
   var write = $Native$Http.write;
   var writeHead = $Native$Http.writeHead;
   ...
   var listen = $Native$Http.listen;
   var createServer = $Native$Http.createServer;
   var createServer$ = F3(function (address,port$,echo) {
      return A2($Task.andThen,
      createServer(address),
      A2(listen,port$,echo));
   });
   var on = $Native$Http.on;
...
Elm.VDOMtoHTML = Elm.VDOMtoHTML || {};
Elm.VDOMtoHTML.make = function (_elm) {
   "use strict";
   _elm.VDOMtoHTML = _elm.VDOMtoHTML || {};
   if (_elm.VDOMtoHTML.values) return _elm.VDOMtoHTML.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$VDOMtoHTML = Elm.Native.VDOMtoHTML.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $VirtualDom = Elm.VirtualDom.make(_elm);
   var _op = {};
   var toHTML = $Native$VDOMtoHTML.toHTML;
   return _elm.VDOMtoHTML.values = {_op: _op,toHTML: toHTML};
};
Elm.Http = Elm.Http || {};
Elm.Http.Server = Elm.Http.Server || {};
Elm.Http.Server.Isomorphic = Elm.Http.Server.Isomorphic || {};
Elm.Http.Server.Isomorphic.Raw = Elm.Http.Server.Isomorphic.Raw || {};
Elm.Http.Server.Isomorphic.Raw.make = function (_elm) {
   "use strict";
   _elm.Http = _elm.Http || {};
   _elm.Http.Server = _elm.Http.Server || {};
   _elm.Http.Server.Isomorphic = _elm.Http.Server.Isomorphic || {};
   _elm.Http.Server.Isomorphic.Raw = _elm.Http.Server.Isomorphic.Raw || {};
   if (_elm.Http.Server.Isomorphic.Raw.values)
   return _elm.Http.Server.Isomorphic.Raw.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $String = Elm.String.make(_elm),
   $Task = Elm.Task.make(_elm),
   $VDOMtoHTML = Elm.VDOMtoHTML.make(_elm);
   var _op = {};
   var embed = F2(function (_p0,html) {
      var _p1 = _p0;
      var joinOn = A2($Basics.flip,$String.join,_p1._0);
      var g = function (js) {
      ...
      return A2($Task.andThen,
      $FS$Raw.readFile(_p1._1),
      function (_p2) {
         return $Task.succeed(g(_p2));
      });
   });
   var writeElm = F3(function (res,elmId,html) {
      return A2($Task.andThen,
      A2(embed,elmId,html),
      $Http$Server$Raw.writeHtml(res));
   });
   return _elm.Http.Server.Isomorphic.Raw.values = {_op: _op
                                                   ,embed: embed
                                                   ,writeElm: writeElm};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var elmId = {ctor: "_Tuple2"
               ,_0: _U.list(["Main"])
               ,_1: "examples/LowLevel/isomorphic-templating/main.js"};
   var view = function (m) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,
              _U.list([]),
              _U.list([$Html.text(function (_) {    return _.text;}(m))]))
              ,A2($Html.input,_U.list([]),_U.list([]))]));
   };
   var Model = function (a) {    return {text: a};};
   var initial = Model("Wowzers in my Trousers");
   var main = view(initial);
...
Elm.Server.make = function (_elm) {
   ...
   $Debug = Elm.Debug.make(_elm),
   $FS$Raw = Elm.FS.Raw.make(_elm),
   $Http$Server$Isomorphic$Raw = Elm.Http.Server.Isomorphic.Raw.make(_elm),
   $Http$Server$Raw = Elm.Http.Server.Raw.make(_elm),
   $Json$Encode = Elm.Json.Encode.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var route = function (_p0) {
      ...
      {case "GET": var _p3 = $Http$Server$Raw.url(_p4);
           ...
           {case "/": return A2($Http$Server$Raw.writeHtml,
                _p5,
                "<h1>Wowzers</h1>");
              case "/foo": return A3($Http$Server$Isomorphic$Raw.writeElm,
                _p5,
                $Main.elmId,
                $Main.view($Main.initial));
