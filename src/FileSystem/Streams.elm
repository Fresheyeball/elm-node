module FileSystem.Streams (createReadStream, createReadStream', createWriteStream, createWriteStream') where
...
-}
createReadStreamWithOptions : ReadOptions -> FilePath -> Task x (Readable {})
createReadStreamWithOptions opts path =
...
createReadStream =
    createReadStreamWithOptions defaultReadOptions
        |> marshallReadable
